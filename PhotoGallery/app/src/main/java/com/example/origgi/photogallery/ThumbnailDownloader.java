...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    public void queueThumbanil(T target, String url){
        ...
        try{
            ...
            mResponseHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mRequestMap.remove(target);
                    mTThumbnailDownloadListener.onThumbnailDownloadListener(target, bitmap);
                }
            });
        }
        catch (IOException ioe){
            Log.e(TAG, "Error doenloading image", ioe);
        }
    }
